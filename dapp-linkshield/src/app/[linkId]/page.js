    ...
    <>
      <div className="container px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div className="col-6">
            <img
              src="https://images.unsplash.com/photo-1541543975512-86aad5d2cf93?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="col-6">
            ...
            <p className="lead">Este link esta protegido pela LinkShield</p>
            <hr />
            <p>
              Para acessar o conteudo original, conecte sua carteira abaixo e
